...
func TestReconcilePendingFileUpdateQuarantinesForeignTarget(t *testing.T) {
	...
	repairExecutable = func() (string, error) { return filepath.Join(t.TempDir(), "inx-guard"), nil }
...
func TestPrepareFileUpdateQuarantinesForeignTarget(t *testing.T) {
	...
	repairExecutable = func() (string, error) { return filepath.Join(newLauncherDir, "inx-guard"), nil }
	newTarget := filepath.Join(newLauncherDir, "inx-desktop")
