...
// FileRevision is the v2 per-file preimage plus last Inx-owned after fingerprint.
type FileRevision struct {
	...
	// AfterSHA256 is the fingerprint of the file after the last Inx-owned write.
