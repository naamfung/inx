// Package netclient builds HTTP clients and proxy resolvers that share Inx's
...
// NewHTTPClient returns an HTTP client with Inx proxy settings applied.
