...
// `inx version` / `inx --version`. Release builds may only fill
...
//   - `inx --version` / `-v` stay single-line: "inx <version>"
//   - `inx version --verbose` prints structured fields
//   - `inx version --json` prints a JSON object
...
// versionCommand handles `inx version [flags]`. When allowFlags is false
