...
// remoteConnectSyntax is the parsed form of `inx remote connect|open …`.
...
const remoteConnectUsage = "usage: inx remote connect <name> [flags]"

// parseRemoteConnectSyntax accepts both documented orders:
//
//	inx remote connect <name> [flags]
//	inx remote connect [flags] <name>
//
...
const remoteServeUsage = "usage: inx remote serve start|stop|status|logs <name> [--workspace PATH] [-n N]"
