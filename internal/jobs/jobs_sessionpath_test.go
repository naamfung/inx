...
func TestValidateTrustedSessionPath(t *testing.T) {
	cases := []struct {
		...
		{"absolute posix path", "/home/u/.inx/sessions/abc.jsonl", false},
		{"absolute windows path", `C:\Users\me\.inx\sessions\abc.jsonl`, false},
		{"workspace-relative", "sessions/abc.jsonl", false},
		// Filenames with a hidden segment are still legitimate.
		{"..hidden is allowed", "/home/u/.inx/..hidden.jsonl", false},
