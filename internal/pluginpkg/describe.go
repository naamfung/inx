...
func RuntimeTrustText(rt *RuntimeSpec) string {
	...
	b.WriteString("  risk: the runtime process runs inside Inx — it can read the full session and environment, bypass permissions, and operate this machine directly.\n")
	return b.String()
}
