// Package memory implements Inx's persistent memory. It mirrors Claude
// Code's two-layer model while honoring Inx's cache-first architecture:
//
...
const (
	ScopeUser     = instruction.ScopeUser     // ~/.inx/INX.md
...
// INX.md is ours; AGENTS.md and CLAUDE.md are the cross-tool conventions.
