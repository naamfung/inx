...
const (
	envPluginRoot    = "INX_PLUGIN_ROOT"
	envPluginName    = "INX_PLUGIN_NAME"
	envPluginVersion = "INX_PLUGIN_VERSION"
)
...
// resolveRuntimeCommand expands ${INX_PLUGIN_ROOT} and enforces the exec
