// Package sidecar is the host half of Extension Protocol v1: it spawns
...
// (<Inx home>/plugin-packages.json) AND currently enabled. The launch
...
// hooks, and skills, but it can never declare a v1 runtime; keeping this
...
//
// FULL-TRUST CONTRACT: a sidecar process inherits the UNFILTERED Inx
// environment (os.Environ), plus its manifest env and INX_PLUGIN_ROOT /
// INX_PLUGIN_NAME / INX_PLUGIN_VERSION. Sidecars can read
