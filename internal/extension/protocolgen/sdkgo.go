...
func generateSDKTypesGo() ([]byte, error) {
	...
	out.WriteString("\n")
	out.WriteString("// Package extension: Extension Protocol v1 wire DTOs, enums, method\n")
...
func emitSDKMethods(out *strings.Builder) error {
	out.WriteString("// Method names, frozen for Extension Protocol v1.\n")
	out.WriteString("const (\n")
...
func emitSDKEnum(out *strings.Builder, walk *sdkTypeWalk, typ reflect.Type) error {
	...
	fmt.Fprintf(out, "// %s is a generated Extension Protocol v1 string enum.\n", name)
