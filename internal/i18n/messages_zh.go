...
用法：
  ...
  inx config compact-ratio [--local] [65..85]       配置自动压缩阈值
  ...
  inx completion bash|zsh|fish                     打印 shell 补全脚本到 stdout
  inx version [--verbose|--json]                   打印版本（单行）或构建元信息
  inx --version | -v                               单行版本（脚本安全）
  inx help
