...
const SIDEBAR_COLLAPSED_KEY = "inx.sidebar.collapsed";
...
const WORKSPACE_PANEL_OPEN_KEY = "inx.workspacePanel.open";
...
const TERMINAL_PANEL_OPEN_KEY = "inx.terminalPanel.open";
...
const TERMINAL_HEIGHT_KEY = "inx.terminalPanel.height";
