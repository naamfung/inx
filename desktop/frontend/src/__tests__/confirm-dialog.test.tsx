...
const dialog = document.querySelector<HTMLElement>(".inx-confirm-dialog");
const cancelButton = Array.from(document.querySelectorAll<HTMLButtonElement>(".inx-confirm-dialog button"))
  .find((button) => button.textContent === "Cancel");
const deleteButton = Array.from(document.querySelectorAll<HTMLButtonElement>(".inx-confirm-dialog button"))
...
ok(document.querySelector(".inx-confirm-dialog") === null, "Escape cancels and closes the dialog");
...
const secondDeleteButton = Array.from(document.querySelectorAll<HTMLButtonElement>(".inx-confirm-dialog button"))
  .find((button) => button.textContent === "Delete");
await act(async () => {
