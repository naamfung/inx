...
import { inxRehypePlugins, inxRemarkPlugins } from "../components/markdownRemarkPlugins";
import {
  normalizeMath,
...
// These cases cross the real react-markdown → remark-math → Inx AST
