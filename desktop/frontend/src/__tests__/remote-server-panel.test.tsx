...
ok(
  document.body.textContent?.includes("Models, API keys, and sessions are managed by the Inx configuration on the remote server.") === true,
  "server tab states that providers, API keys, and sessions are managed by the remote Inx configuration",
);
