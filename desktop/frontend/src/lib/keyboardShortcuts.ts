...
const SHORTCUTS_STORAGE_KEY = "inx.customShortcuts";
const SHORTCUTS_CHANGED_EVENT = "inx:shortcuts-changed";
...
export const SHORTCUT_DEFINITIONS: readonly ShortcutDefinition[] = [
  ...
  // so native textarea history and Inx transactions share one chord.
  {
