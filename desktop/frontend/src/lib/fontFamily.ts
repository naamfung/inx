...
const FONT_FAMILY_KEY = "inx-font-family";
const CUSTOM_FONT_KEY = "inx-font-family-custom";
const MONO_FONT_FAMILY_KEY = "inx-mono-font-family";
const CUSTOM_MONO_FONT_KEY = "inx-mono-font-family-custom";
