...
export const SUBAGENT_PROGRESS_STATUS = "inx.subagent.status";
export const SUBAGENT_PROGRESS_REASONING = "inx.subagent.reasoning";
export const SUBAGENT_PROGRESS_TEXT = "inx.subagent.text";
export const SUBAGENT_PROGRESS_NOTICE = "inx.subagent.notice";

// Reserved names are matched by prefix so a future channel never falls back
// to ordinary tool output on older frontends.
const SUBAGENT_PROGRESS_PREFIX = "inx.subagent.";
