...
// under inx.io. That lets a subdomain (e.g. crash.inx.io) return
...
export function safeNext(next, origin) {
  ...
  if (u.protocol === "https:" && (u.host === "inx.io" || u.host.endsWith(".inx.io"))) return u.href;
  return null;
}
