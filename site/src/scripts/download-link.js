...
export function downloadPaneFromURL(input, base = "https://inx.io/") {
  let url;
  try {
...
export function releaseChannelFromURL(input, base = "https://inx.io/") {
  let url;
  try {
    url = new URL(input, base);
  } catch {
...
export function downloadURLForPane(input, pane, channel, base = "https://inx.io/") {
